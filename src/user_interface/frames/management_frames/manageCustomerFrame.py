...
class ManageCustomerFrame(tk.Toplevel):
    ...
    def __save_customer(self):
        customerManager.insert_customer(random.randint(10000, 99999), self.name_input.get("1.0",'end-1c'), self.address_input.get("1.0",'end-1c'), self.email_input.get("1.0",'end-1c'), self.phone_input.get("1.0",'end-1c'))
        self.destroy()
